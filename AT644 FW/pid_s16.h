...
typedef enum _Pid_s16_config
{
	...
	LP_ERR_GAIN				= 8,	//Gain for the low pass error estimation. Valid values are from 1 to (1<<PID_ERR_FP).
...
class Pid_s16
{
	...
	public:
		...
		//true = configuraton parameters of PID class are bad
